...
reg.exe add "HKLM\%HIVE%\Control\Class\{71a27cdd-812a-11d0-bec7-08002be2092f}" /v "LowerFilters" /t REG_MULTI_SZ /d "fvevol\0iorate" /f
...
reg.exe add "HKLM\%HIVE%\Services\AdobeUpdateService" /v "Start" /t REG_DWORD /d "4" /f
...
reg.exe add "HKLM\%HIVE%\Services\Appinfo" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\AppXSvc" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\AudioEndpointBuilder" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\Audiosrv" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\brave" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\BraveElevationService" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\bravem" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\BraveVpnService" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\BraveVpnWireguardService" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\BrokerInfrastructure" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\camsvc" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\CoreMessagingRegistrar" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\cphs" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\cplspcon" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\CredentialEnrollmentManagerUserSvc" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\CryptSvc" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\CscService" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\DcomLaunch" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\Dhcp" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\FrameServerMonitor" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\fvevol" /v "Start" /t REG_DWORD /d "0" /f
reg.exe add "HKLM\%HIVE%\Services\FvSvc" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\GoogleChromeElevationService" /v "Start" /t REG_DWORD /d "4" /f
...
reg.exe add "HKLM\%HIVE%\Services\GpuEnergyDrv" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\GraphicsPerfSvc" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\gupdate" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\gupdatem" /v "Start" /t REG_DWORD /d "4" /f
...
reg.exe add "HKLM\%HIVE%\Services\igccservice" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\igfxCUIService2.0.0.0" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\LSM" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\MozillaMaintenance" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\msisadrv" /v "Start" /t REG_DWORD /d "0" /f
reg.exe add "HKLM\%HIVE%\Services\MSiSCSI" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\msiserver" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\MsKeyboardFilter" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\MSKSSRV" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\Netman" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\netprofm" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\NetSetupSvc" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\NlaSvc" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\NvContainerLocalSystem" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\PlugPlay" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\Power" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\ProfSvc" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\RpcEptMapper" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\RpcLocator" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\RpcSs" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\rspndr" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\RstMwService" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\RustDesk" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\StateRepository" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\StiSvc" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\TeamViewer" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\Telemetry" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\TermService" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\TextInputManagementService" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\TrustedInstaller" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\tunnel" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\tzautoupdate" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\UdkUserSvc" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\UserManager" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\UsoSvc" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\vgc" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\WaaSMedicSvc" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\Wcmsvc" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\Winmgmt" /v "Start" /t REG_DWORD /d "2" /f
reg.exe add "HKLM\%HIVE%\Services\WinRM" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\WlanSvc" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\WMPNetworkSvc" /v "Start" /t REG_DWORD /d "4" /f
...
reg.exe add "HKLM\%HIVE%\Services\WSearch" /v "Start" /t REG_DWORD /d "2" /f
